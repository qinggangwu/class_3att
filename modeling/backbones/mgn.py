...
class MGN(nn.Module):
    def __init__(self, num_classes=751):
        ...
        pretrained_path = '/home/liujie/workspace/data/models/pytorch/pretrained/resnet50-19c8e357.pth'
        ...
        self.fc_id_2048_0 = nn.Linear(feats, self.num_classes)
        self.fc_id_2048_1 = nn.Linear(feats, self.num_classes)
        self.fc_id_2048_2 = nn.Linear(feats, self.num_classes)

        self.fc_id_256_1_0 = nn.Linear(feats, self.num_classes)
        self.fc_id_256_1_1 = nn.Linear(feats, self.num_classes)
        self.fc_id_256_2_0 = nn.Linear(feats, self.num_classes)
        self.fc_id_256_2_1 = nn.Linear(feats, self.num_classes)
        self.fc_id_256_2_2 = nn.Linear(feats, self.num_classes)
